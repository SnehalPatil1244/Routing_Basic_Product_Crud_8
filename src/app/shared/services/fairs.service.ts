...
export class FairsService {
  ...
  fairsArr: Array<Ifairs> = [
    ...
    },
    {
      ...
      isCandidateRegistered: false,
      bannerUrl:
        'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?q=80&w=1794&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      showRegisteredUsersToCandidate: false,
      showRegisteredUsersToSchools: false,
      showRegisteredSchoolsToCandidate: true,
      showRegisteredSchoolsToSchools: false,
    ...
    },
    {
      ...
      isCandidateRegistered: false,
      bannerUrl:
        'https://images.unsplash.com/photo-1496055401924-5e7fdc885742?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      showRegisteredUsersToCandidate: false,
      showRegisteredUsersToSchools: false,
      showRegisteredSchoolsToCandidate: true,
      showRegisteredSchoolsToSchools: false,
  ...
  fetchfairsById(id: string): Observable<Ifairs> {
    let fairsObj = this.fairsArr.find(f => f.fairId === id)!
    return of(fairsObj)
  }
}
